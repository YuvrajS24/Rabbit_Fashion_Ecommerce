...
const selectedProduct =  {
    ...
    images:[
        {
        url:"https://picsum.photos/500/500?radom=1",
        altText:"Stylish Jacket 1",
    },
        {
        url:"https://picsum.photos/500/500?radom=2",
       ...
       <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
          ...
          <div className='flex flex-col md:flex-row'>
               ...
               {selectedProduct.images.map((image,index)=>(
                 ...
                 cursor-pointer border ${mainImage === image.url? " border-black" : " border-gray-300 "}`}
                ...
                <div className='mb-4'>
                       ...
                       <div className='flex gap-2 mt-2 '>
                         ...
                         {selectedProduct.sizes.map((size)=>(
                            ...
                            key={size} className={` px-4 py-2 rounded border ${selectedSize=== size ? "bg-black text-white"
                             : ""}   `}>
                            {size}
                            </button>
